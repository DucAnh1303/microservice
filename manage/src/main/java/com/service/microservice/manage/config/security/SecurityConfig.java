package com.service.microservice.manage.config.security;

import com.service.microservice.manage.config.filter.JwtFilterAuthentication;
...
public class SecurityConfig {
    ...
    private UrlBasedCorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:9093", "http://localhost:9090"));
